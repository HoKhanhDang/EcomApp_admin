            ...
            rules: [
                ...
                },
                {
                    ...
                    use: [
                        ...
                        {
                            loader: 'postcss-loader', // Thêm loader này
                            options: {
                                postcssOptions: {
                                    ident: 'postcss',
                ...
                {
                    test: /\.(png|svg|jpg|jpeg|gif)$/, // Dùng để import file ảnh, nếu có video/ảnh định dạng khác thì thêm vào đây
                    use: [
                        {
                            loader: 'file-loader',
                            options: {
                        ...
                        },
                        {
                            ...
                            options: {
                                ...
                                // Optimize PNG images (alternative to optipng)
                                pngquant: {
                                    quality: [0.65, 0.9],
                                    speed: 4
                                },
                                // Optimization for GIF images
                                gifsicle: {
                                    interlaced: false
                                },
                                // Optimization for SVG files
                                svgo: {
                                    enabled: true
                                },
                                // Enable/disable, based on production mode
                                disable: !isProduction // Only enable in production for faster development builds
                            }
                        }
                    ]
                },
